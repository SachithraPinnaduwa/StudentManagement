...
const StudentTable = ({ user }: { user: Student }) => {
  ...
  const handleEdit = (studentId:string, status:boolean) => {
  ...
  const handleStatusChange = async () => {
    try {
      await axios.put(`http://localhost:8080/student/${editingStudentId}`, {
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    {editingStudentId === student._id ? (
                      ...
                      <button
                        onClick={() => handleEdit(student._id, student.status)}
                        className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                      >
                        Edit
                      </button>
                  ...
                  <td className="px-6 py-4">
                    <button
                      ...
                      className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                    >
                      Delete
                    </button>
                  </td>
